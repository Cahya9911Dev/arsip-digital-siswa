    ...
    foreach($siswa as $sw) : ?>
        <tr>
            ...
            <td class="text-center">
                <?= anchor('staff/siswa/detail/'.$sw->siswa_id,'<div class="btn btn-primary btn-sm">Detail</div>') ?>
                <a class="btn btn-warning btn-sm" href="<?= base_url('staff/siswa/updatesiswa/'.$sw->siswa_id)?>">Edit</a>
                <a class="btn btn-default btn-sm" href="<?= base_url('staff/siswa/ubahpassword/'.$sw->siswa_id)?>">Ubah Password</a>
